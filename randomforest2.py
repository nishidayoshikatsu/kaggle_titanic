...
train= pd.read_csv("./all/train.csv").replace("male",0).replace("female",1).replace("S",0).replace("C",1).replace("Q",2)
test= pd.read_csv("./all/test.csv").replace("male",0).replace("female",1).replace("S",0).replace("C",1).replace("Q",2)
...
import csv
with open("./result/randomforest2.csv", "w") as f:
